...
Ball.prototype.update = function () {
  ...
  if (this.coords.x < 0 || this.coords.x > 800 - this.width) {
      ...
      if (this.coords.x < 0) {
          for(var gameplayer in this.game.players) {
            var player = this.game.players[gameplayer];
            if(player.side == 'right') {
              player.score++;
              this.game.broadcast('score',{'side' : 'right', 'score' : player.score});
            }
          }
          ...
          for(var gameplayer in this.game.players) {
            ...
            if(player.side == 'left') {
              player.score++;
              this.game.broadcast('score',{'side' : 'left', 'score' : player.score});
            }
          }
      }
      this.stop = true;
